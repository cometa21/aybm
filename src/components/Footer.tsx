...
import logoJBM from "@/assets/logo-jbm.png"; // Ajusta la ruta si es necesario

const Footer = () => {
  const currentYear = new Date().getFullYear();

  return (
    <footer aria-label="Pie de página - JBM Cítricos Premium" className="bg-lime-900 text-lime-100 py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="group w-12 h-12 rounded-full bg-gradient-to-br from-lime-500 to-lime-600 flex items-center justify-center">
                <img
                  src={logoJBM}
              ...
              <div>
                ...
                <span className="block text-xs text-citrus-400 font-medium tracking-wider uppercase">
                  Premium
                </span>
              </div>
            </div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-lime-200/80 hover:text-citrus-400 transition-colors"
                >
                  +52 (425) 115-2205
                </a>
              </li>
        ...
        <div className="pt-8 border-t border-lime-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-lime-200/60">
            <a href="/privacidad" className="hover:text-citrus-400 transition-colors">
              Política de Privacidad
            </a>
            <a href="/terminos" className="hover:text-citrus-400 transition-colors">
              Términos y Condiciones
            </a>
            <a href="/cookies" className="hover:text-citrus-400 transition-colors">
              Política de Cookies
            </a>
          </div>
        </div>
